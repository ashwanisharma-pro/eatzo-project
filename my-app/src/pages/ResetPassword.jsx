      ...
      <div className="auth-split-wrapper">
        ...
        <div className="auth-brand-side">
          ...
          <div className="brand-content">
            <h2>Secure <span>Reset.</span></h2>
            <p>Choose a strong password to protect your account and get back to exploring the best flavors in town.</p>
          </div>
          ...
          <div className="form-container">
            {!success ? (
              ...
              <div style={{ textAlign: 'center', padding: '40px 0' }}>
                ...
                <h4 style={{ color: '#fff', fontSize: '1.5rem', fontWeight: '800', marginBottom: '16px' }}>Password Reset!</h4>
                <p style={{ color: '#94a3b8', lineHeight: '1.6', marginBottom: '30px' }}>
                  Your password has been successfully updated. You can now log in with your new credentials.
                </p>
                <Link to="/login" className="btn-auth-full" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  Go to Login
                </Link>
              </div>
            )}
            ...
            <div style={{ marginTop: '40px', display: 'flex', alignItems: 'center', gap: '15px' }}>
              ...
              <span style={{ fontSize: '0.85rem', color: '#64748b' }}>We recommend using at least 12 characters with numbers and symbols.</span>
            </div>
          </div>
        </div>
      </div>
